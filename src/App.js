    ...
    constructor(props) {
        ...
        this.state = {
            ...
            esps: {
                ...
                '3c:61:05:13:de:c0': {x: 0, y: 1000, sort: 1}, // 3 on bard with arduino
                '3c:61:05:13:e4:08': {x: 1530, y: 0, sort: 2}, // 1 loos
                '3c:61:05:13:e2:18': {x: 1530, y: 1000, sort: 3}, // 2 on board with lamps
            },
            visible: false,
            width: 1609,
            height: 1309,
            widthMeters: 1609, // the width of the warehouse 8.5
            orderBeacons: []
        }
    }
